...
public class FibonacciSeries {
	...
	public static void main(String[] args) {
		...
		long[] ar1 = new long[fib3 + 1];
		fibonacciSeries.initializeMemonize(ar1, fib1);

		startTime = LocalDateTime.now();
		System.out.println("\nSum of " + fib3 + " is : " + fibonacciSeries.usingTopDownApproch(fib3, ar1));
		endTime = LocalDateTime.now();
		duration = ChronoUnit.MILLIS.between(startTime, endTime);
...
Time taken to compute using Divide and Conquer Algorithm is (ms) : 19343
